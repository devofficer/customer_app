...
export const renderStatic = (pageType: string) => {
  return html`
    <!doctype html>
    <html>
      <head>
      ...
      <body dsd-pending>
        ...
        <defie-page-customer-view></defie-page-customer-view>
        <script type="module">
...
export function* renderPage(pageType: string) {
  yield `
    <!doctype html>
    <html>
      <head>
  ...
  `;
  switch (pageType) {
    case 'view': yield* render(html`<defie-page-customer-view></defie-page-customer-view>`); break;
    case 'create': yield* render(html`<defie-page-customer-create></defie-page-customer-create>`); break;
  }
  yield `
      <script type="module">
        // Start fetching the Lit hydration support module (note the absence
